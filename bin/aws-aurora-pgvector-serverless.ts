...
new AwsAuroraPgvectorServerlessStack(app, `${owner}-${deployEnvironment}-AwsAuroraPgvectorServerlessStack`, {
    ...stackProps,
    stackName: `${owner}-${deployEnvironment}-AwsAuroraPgvectorServerlessStack`,
